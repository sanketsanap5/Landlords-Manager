...
<!-- navigation Bar END-->
				...
				<div class="panel panel-success">								<!-- Panel start -->
					...
					<div class="panel-body">
						<form action="MakePayment" method="post">
							...
							<br> 
							<input class="form-control btn btn-success" type="submit"  onclick="checkRent();" value="Submit">
						</form>	
					</div>
				</div>
	...
	function checkRent()
	{
		...
		var rent=document.getElementById('PaymentAmount').value;
		if(rent<=0)
		{
			alert("Check Rent Again !!!");
		}
	...
	<script type="text/javascript">
		function check()
		{
			...
			{
				alert("Meter Reading for this Month is Already Updated");
			}
