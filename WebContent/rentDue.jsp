...
<body>
	...
	<div class="container-fluid">											<!--  Container 2 start -->
		<div class="row">													<!--  Row 2 start -->
			...
			<div class="input-group">
				<div class="list-group">
					...
					<a href="#" class="list-group-item list-group-item-warning list-group-item-action active">Rent / Payment</a>
					<a href="OwnerMeterDetails.jsp" class="list-group-item list-group-item-warning list-group-item-action ">Meter Details</a>		
					<a href="TenantDetails.jsp" class="list-group-item list-group-item-warning list-group-item-action ">Tenant Details</a>		
				</div>
				</div>
			</div>
		...
		<div class="row">													<!-- Row 3 Start -->
			<div class="col-md-2 col-xs-4">		</div>							<!-- COL 1 -->
			
			<div class="col-md-3 col-xs-8">
				<div class="input-group">
					<div class="list-group ">
							<div class=" list-group-item list-group-item-info">
								<div class="text-center info">Entire History </div>
							</div>
							<input type="button" class="form-control" data-toggle="collapse" data-target="#rentdueHistory" value="Rent Due">
							
							<input type="button" class="form-control" data-toggle="collapse" data-target=#EntirePaymentHistory value="Payment Details">
			...
			<div class="  col-md-5 col-xs-12 collapse" id="rentdueHistory">
			...
			<div class="col-md-5 col-xs-12 collapse" id="EntirePaymentHistory">
